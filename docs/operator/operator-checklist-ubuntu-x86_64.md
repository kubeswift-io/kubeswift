...
| **Cloud Hypervisor v37+** | Containerfile pins CH v37; CLI format must match |
...
See [worker-node-preflight.md](worker-node-preflight.md) for download instructions, result interpretation, and exit codes.
