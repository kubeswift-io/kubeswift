...
// When networking is enabled, sets net.ipv4.ip_forward=1 via namespaced sysctl.
// Clusters must allowlist this sysctl in kubelet config (--allowed-unsafe-sysctls=net.ipv4.ip_forward).
