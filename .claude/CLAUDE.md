...
- `/technical-writer` — documentation: context docs, design sketches, CRD reference, runbooks, sample manifests, CHANGELOG
...
- CLOUDHV.fd loads via `--kernel` for Cloud Hypervisor disk boot, NEVER `--firmware`
